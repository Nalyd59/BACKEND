<nav>
    ...
    <a type="button" class="list-group-item list-group-item-action" href="?idPage=fonc" >Fonctions</a>
    <a type="button" class="list-group-item list-group-item-action" href="?idPage=supp" >Supprimer</a>
</nav>